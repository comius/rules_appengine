...
```
$ bazel build --java_runtime_version=8 --extra_toolchains=@io_bazel_rules_appengine//appengine:jdk8_definition //my-project
```
...
build --extra_toolchains=@io_bazel_rules_appengine//appengine:jdk8_definition
```
